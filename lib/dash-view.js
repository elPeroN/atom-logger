...
export default class DashView {
  ...
  constructor() {
    ...
    this.unsendCount = document.createElement('div');
    this.unsendCount.textContent = 'Unsend metrics : 0';
    sessionContainer.appendChild(this.unsendCount);
  ...
  async startSession() {
    ...
    this.unsendCount.textContent = 'Unsend Metrics:' + metrics.length;
