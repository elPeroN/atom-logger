...
export default {
  ...
  async activate(state) {
    ...
    if(await server.isAuthenticated()){
      this.atomLoggerDashView = new DashView(state.atomLoggerDashViewState, db);
      var item = this.atomLoggerDashView.getElement();
    }else{
      this.atomLoggerLoginView = new LoginView(state.atomLoggerLoginViewState, server);
      var item = this.atomLoggerLoginView.getElement();
    }
