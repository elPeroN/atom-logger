...
import AtomLoggerDashView from './atom-logger-dash-view';
...
export default {
  ...
  activate(state) {
    this.atomLoggerLoginView = new AtomLoggerLoginView(state.atomLoggerLoginViewState);
    this.atomLoggerDashView = new AtomLoggerDashView(state.atomLoggerDashViewState);
